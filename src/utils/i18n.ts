const fallbackMessages: Record<string, string> = {
  ...
  previouslyTracked: 'History records',
  viewDetails: 'View details',
  downloadCancelled: 'Download cancelled',
  partialSuccessToast: '$1 downloaded, $2 failed',
  ...
  allImagesSuccess: 'All $1 images downloaded',
  ...
  partialSuccessSummary: '$1 downloaded, $2 failed',
  ...
  allImagesFailed: 'None of the $1 images were downloaded',
  ...
  itemsCount: '$1 items',
  retry: 'Retry',
  retryUnfinished: 'Retry unfinished ($1)',
  retryStarted: 'Retry started',
  retryFailedToast: 'Retry failed',
  noUnfinishedItems: 'No unfinished items',
  ...
  rangeOneMoreSegment: '1 more range',
  rangeMoreSegments: '$1 more ranges',
  total: 'Total',
  countDone: '$1 done',
  countInProgressShort: '$1 in-progress',
  countQueuedShort: 'Queued $1',
  ...
  taskRange: 'Range',
  imageCount: '$1 images',
  rangeAllDownloaded: 'All downloaded',
  countDownloadedRatio: 'Downloaded $1/$2',
  countPendingShort: '$1 pending',
  backToInitial: 'Back to download range',
  close: 'Close',
