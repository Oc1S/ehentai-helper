...
import { withErrorBoundary, withSuspense } from '@/shared';
...
export const Page = withErrorBoundary(withSuspense(PageLayout, <div>Loading ...</div>), <div>Something went wrong</div>);
